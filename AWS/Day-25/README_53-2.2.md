...
```bash
   Domain name: the same name of your domain(devops.com)
   Description: ---
...
- type "www.techproeducation.com". show which content is seen "local instance content" in VPC 
- go to the public browser than type browser: "www.techproeducation.com" than show that, N.Virginia instance is seen on public internet.
