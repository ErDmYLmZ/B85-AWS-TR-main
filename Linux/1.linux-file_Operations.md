...
- Show the first 2 lines of techproed.txt

```bash
head -2 techproed.txt
```
...
- Show the last line of techproed.txt

```bash
tail -1 techproed.txt
```
