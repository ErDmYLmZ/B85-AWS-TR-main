...
- Create a `devops-deploy.yaml` and input text below. Pay attention that image version is 1.0.
...
```bash
kubectl set image deploy devops-deploy container-info-c=gluobe/container-info:blue
```
