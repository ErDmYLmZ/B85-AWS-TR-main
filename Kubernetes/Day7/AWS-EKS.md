...
```
- use the proper link in the page:
...
- Verify that you can see your cluster listed, when created and authenticated
...
- use the default Kubernetes version for the cluster
...
- use a dedicated VPC and subnets for the Kubernetes Cluster

- you can skip security groups

- Cluster endpoint access should be set to Public and private

- Leave Networking add-ons as they are
...
6. On the ```Specify networking``` page:
    ...
    - Be careful to choose public subnets to not get errors.
